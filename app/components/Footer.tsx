          ...
          <div className="mb-8 lg:mb-0 md:mb-0 lg:max-w-xs md:max-w-xs">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col space-y-3">
              <input
                ...
                required
                className="px-4 py-2 bg-white bg-opacity-20 backdrop-blur-sm rounded-lg border border-white border-opacity-20 placeholder-neutral-700 text-neutral-700 focus:outline-none focus:ring-2 focus:ring-white focus:ring-opacity-50"
              />
              <button
                aria-label="Submit"
                type="submit"
                className="bg-orange-500/40 backdrop-blur-[10px] text-white cursor-pointer font-medium py-2 px-4 rounded-lg hover:bg-orange-500/20 transition duration-300"
              >
                Subscribe
              </button>
            </form>
